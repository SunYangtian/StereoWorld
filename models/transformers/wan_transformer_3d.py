...
class WanSelfAttention(nn.Module):
    ...
    def forward(self, x, seq_lens, grid_sizes, freqs, dtype=torch.bfloat16, t=0, temporal_indices=None, **kwargs):
        r"""
        Args:
...
class WanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        y = self.self_attn(temp_x, seq_lens, grid_sizes, freqs, dtype, temporal_indices=temporal_indices)
